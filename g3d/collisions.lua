...
local fastSubtract = vector.subtract
local vectorCrossProduct = vector.crossProduct
local vectorDotProduct = vector.dotProduct
...
-- so instead all vector are all represented using three number variables each
...
---    http://www.lighthouse3d.com/tutorials//ray-triangle-intersection/
...
local function triangleCapsule(
    ...
    local side1_x, side1_y, side1_z = tri_1_x - tri_0_x, tri_1_y - tri_0_y, tri_1_z - tri_0_z
    local side2_x, side2_y, side2_z = tri_2_x - tri_0_x, tri_2_y - tri_0_y, tri_2_z - tri_0_z
    n_x, n_y, n_z = vectorNormalize(vectorCrossProduct(side1_x, side1_y, side1_z, side2_x, side2_y, side2_z))

    local dotOfNormals = abs(vectorDotProduct(n_x, n_y, n_z, capn_x, capn_y, capn_z))
